...
public:
    Car(int _Id, std::string _name, int _weight, int _numOfPassengers, int _numOfCylinders, int _engineCapacity, bool _hasParkingSensor) {
        Id = _Id; name = _name; weight = _weight; numOfPassengers = _numOfPassengers; numOfCylinders = _numOfCylinders;
